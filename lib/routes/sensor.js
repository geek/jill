...
exports.get = {
    ...
    handler: function (request, reply) {
        ...
        request.server.pack.app.data.getSensor(request.params.radioId, request.params.sensorId, function (err, data) {
...
exports.createCommand = {
    ...
    handler: function (request, reply) {
        ...
        request.server.pack.app.data.addCommand(command, function (err, data) {
