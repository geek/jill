...
exports.update = {
    ...
    handler: function (request, reply) {
        ...
        request.server.pack.app.data.updateSensor(request.params.radioId, request.params.sensorId, sensor, function (err, data) {
...
exports.get = {
    ...
    handler: function (request, reply) {
        ...
        request.server.pack.app.data.getSensor(request.radioId, request.sensorId, function (err, data) {
...
exports.createCommand = {
    ...
    handler: function (request, reply) {
        ...
        request.server.pack.app.data.getSensor(radioId, sensorId, function (err, sensor) {
            ...
            request.server.app.data.addCommand(command, function (err, data) {
...
exports.createReading = {
    ...
    handler: function (request, reply) {
        ...
        request.server.pack.app.data.saveReading(request.params.radioId, request.params.sensorId, reading, function (err, response) {
