...
exports.get = {
    ...
    handler: function (request, reply) {
        ...
        request.server.pack.app.data.getRadio(request.params.radioId, function (err, radio) {
...
exports.update = {
    ...
    handler: function (request, reply) {
        ...
        request.server.pack.app.data.updateRadio(request.params.radioId, radio, function (err, result) {
