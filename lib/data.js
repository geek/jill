...
internals.Data.prototype.getLogs = function (callback) {

    this._logs.find().toArray(callback);
};
...
internals.Data.prototype.getLog = function (logId, callback) {

    this._logs.findOne({ _id: logId }, callback);
};
