...
internals.Data.prototype.addCommand = function (command, callback) {
    ...
    this._db.collection('commands').insert(command, callback);
};
...
internals.Data.prototype.getCommands = function (callback) {
    ...
    this._db.collection('commands').find().toArray(function (err, commands) {
        ...
        self._db.collection('commands').drop(function (err) {
